...
#Getting Data
train_data<-read.csv("C:\\Users\\ASHISH\\Downloads\\comptn\\zs\\ZSTrainingDataset.csv")
test_data<-read.csv("C:\\Users\\ASHISH\\Downloads\\comptn\\zs\\ZSEvaluationDataset.csv")

#Processing Datasets
Result<-train_data$Result
mod_data<-rbind(train_data,test_data)
mod_data<-mod_data[,c("Anonymous.Variable.1","Anonymous.Variable.2","Anonymous.Variable.3")
